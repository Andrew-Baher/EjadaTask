/*
Deployment script for EjadaTaskDB
...
GO
:setvar DatabaseName "EjadaTaskDB"
:setvar DefaultFilePrefix "EjadaTaskDB"
...
GO
PRINT N'Creating [dbo].[Depatment]...';
...
ALTER TABLE [dbo].[DepartmentManager]
    ADD FOREIGN KEY ([DepId]) REFERENCES [dbo].[Depatment] ([Id]);
...
ALTER TABLE [dbo].[Employee]
    ADD FOREIGN KEY ([EmpDept]) REFERENCES [dbo].[Depatment] ([Id]);
